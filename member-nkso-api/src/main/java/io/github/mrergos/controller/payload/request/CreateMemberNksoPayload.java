...
@Data
@AllArgsConstructor
public class CreateMemberNksoPayload {
    @NotNull(message = "{manager.member.creating.error.registryNum_is_required}")
    @Size(max = 5, message = "{manager.member.creating.error.registryNum_must_be_shorter}")
